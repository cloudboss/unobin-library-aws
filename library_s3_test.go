		...
		"s3-bucket": {
			...
			Constraints: []lang.ConstraintSpec{
				...
				},
				{
					...
					Require: "(input.versioning.mfa-delete == 'Enabled' || input.versioning.mfa-delete == 'Disabled')",
				...
				},
				{
					Kind: "at-most-one-of",
					Fields: []string{
						"input.object-lock.rule.default-retention.days", "input.object-lock.rule.default-retention.years",
					},
				},
				{
					Kind: "predicate",
				...
				},
				{
					Kind: "at-most-one-of",
					Fields: []string{
						"input.lifecycle.rules[*].filter.prefix", "input.lifecycle.rules[*].filter.tag",
						"input.lifecycle.rules[*].filter.object-size-greater-than",
						"input.lifecycle.rules[*].filter.object-size-less-than", "input.lifecycle.rules[*].filter.and",
					},
				},
				{
					Kind: "at-most-one-of",
