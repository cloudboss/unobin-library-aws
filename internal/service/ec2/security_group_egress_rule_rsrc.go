...
// SecurityGroupEgressRuleResource is one outbound rule on a VPC security group. It
...
// SecurityGroupEgressRuleResourceOutput holds the values EC2 computes for the rule:
// its server-assigned id and the ARN composed from that id, the region, the
// partition, and the owner account id.
type SecurityGroupEgressRuleResourceOutput struct {
...
func (r *SecurityGroupEgressRuleResource) rule() sgRule {
	return sgRule{
...
func (r *SecurityGroupEgressRuleResource) SchemaVersion() int { return 1 }
...
func (r *SecurityGroupEgressRuleResource) ReplaceFields() []string {
	return []string{
		"security-group-id",
		"cidr-ipv4",
		"cidr-ipv6",
...
func (r SecurityGroupEgressRuleResource) Constraints() []constraint.Constraint {
...
func (r *SecurityGroupEgressRuleResource) Create(
	...
	return &SecurityGroupEgressRuleResourceOutput{SecurityGroupRuleId: ruleID, Arn: arn}, nil
}
