...
func (r *Distribution) expandConfig(
	...
	return &cloudfronttypes.DistributionConfig{
		...
		CacheBehaviors:       expandCacheBehaviors(r.CacheBehaviors),
		CustomErrorResponses: expandCustomErrorResponses(r.CustomErrorResponses),
		Aliases:              expandAliases(r.Aliases),
