...
// VpcSecurityGroupEgressRule is one outbound rule on a VPC security group. It
...
// VpcSecurityGroupEgressRuleOutput holds the values EC2 computes for the rule:
// its server-assigned id and the ARN composed from that id, the region, the
// partition, and the owner account id.
type VpcSecurityGroupEgressRuleOutput struct {
...
func (r *VpcSecurityGroupEgressRule) rule() sgRule {
	return sgRule{
...
func (r *VpcSecurityGroupEgressRule) SchemaVersion() int { return 1 }
...
func (r *VpcSecurityGroupEgressRule) ReplaceFields() []string {
	return []string{
		"security-group-id",
		"cidr-ipv4",
		"cidr-ipv6",
...
func (r VpcSecurityGroupEgressRule) Constraints() []constraint.Constraint {
...
func (r *VpcSecurityGroupEgressRule) Create(
	ctx context.Context, cfg any,
) (*VpcSecurityGroupEgressRuleOutput, error) {
	ruleID, arn, err := sgRuleCreate(ctx, cfg, r.rule(), true)
	if err != nil {
		return nil, err
	}
	return &VpcSecurityGroupEgressRuleOutput{SecurityGroupRuleId: ruleID, Arn: arn}, nil
}

func (r *VpcSecurityGroupEgressRule) Read(
	ctx context.Context, cfg any, prior *VpcSecurityGroupEgressRuleOutput,
) (*VpcSecurityGroupEgressRuleOutput, error) {
...
func (r *VpcSecurityGroupEgressRule) Update(
	ctx context.Context, cfg any,
	prior runtime.Prior[VpcSecurityGroupEgressRule, *VpcSecurityGroupEgressRuleOutput],
) (*VpcSecurityGroupEgressRuleOutput, error) {
...
func (r *VpcSecurityGroupEgressRule) Delete(
	ctx context.Context, cfg any, prior *VpcSecurityGroupEgressRuleOutput,
) error {
