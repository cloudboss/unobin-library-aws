...
func TestLibraryRegistersCloudWatchLocalKinds(t *testing.T) {
	lib := awscloudwatch.Library()
	require.NotNil(t, lib)
	require.Equal(t, "aws-cloudwatch", lib.Name)
