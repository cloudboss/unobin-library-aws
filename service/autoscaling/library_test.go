...
func TestLibraryRegistersAutoScalingLocalKinds(t *testing.T) {
	lib := awsautoscaling.Library()
	require.NotNil(t, lib)
	require.Equal(t, "aws-autoscaling", lib.Name)
