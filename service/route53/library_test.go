...
func TestLibraryRegistersRoute53LocalKinds(t *testing.T) {
	lib := awsroute53.Library()
	require.NotNil(t, lib)
	require.Equal(t, "aws-route53", lib.Name)
