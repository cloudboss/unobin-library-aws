...
func TestLibraryRegistersAPIGatewayV2LocalKinds(t *testing.T) {
	lib := awsapigatewayv2.Library()
	require.NotNil(t, lib)
	require.Equal(t, "aws-apigatewayv2", lib.Name)
