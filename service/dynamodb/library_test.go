...
func TestLibraryRegistersDynamoDBLocalKinds(t *testing.T) {
	lib := awsdynamodb.Library()
	require.NotNil(t, lib)
	require.Equal(t, "aws-dynamodb", lib.Name)
