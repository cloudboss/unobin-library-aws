...
func TestLibraryRegistersEventBridgeLocalKinds(t *testing.T) {
	lib := awseventbridge.Library()
	require.NotNil(t, lib)
	require.Equal(t, "aws-eventbridge", lib.Name)
